        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6">
            <p className="inline-flex items-center gap-2 text-slate-300">
              <Phone size={16} className="text-cyan-300" /> Phone: +91
            </p>
            <p className="mt-3 inline-flex items-center gap-2 text-slate-300">
              <Mail size={16} className="text-cyan-300" /> Email: pranesh@example.com
            </p>
          ...
          <form className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6">
            ...
            <input
              id="name"
              type="text"
              className="mt-2 w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-slate-100 outline-none transition focus:border-cyan-400"
            />
            <label className="mt-4 block text-sm text-slate-300" htmlFor="email">Email</label>
            <input
              id="email"
              type="email"
              className="mt-2 w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-slate-100 outline-none transition focus:border-cyan-400"
            />
            <label className="mt-4 block text-sm text-slate-300" htmlFor="message">Message</label>
            <textarea
              id="message"
              rows={4}
              className="mt-2 w-full rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-slate-100 outline-none transition focus:border-cyan-400"
            ...
            <button
              type="submit"
              className="mt-4 rounded-full bg-gradient-to-r from-cyan-400 to-violet-400 px-5 py-2 font-semibold text-slate-950 transition hover:-translate-y-0.5"
            >
              Send
            </button>
          </form>
