      ...
      <RevealSection id="contact" className="mx-auto mt-20 max-w-6xl px-6 pb-16">
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6">
            ...
            <p className="mt-3 text-slate-300">LinkedIn: https://www.linkedin.com/in/pranesh-kumar-n-0b34b32a5/</p>
            <p className="mt-3 text-slate-300">GitHub: https://github.com/PRANEESSHHH</p>
          </div>
        </div>
      </RevealSection>
